...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--maze", choices=available_mazes(), default="classic", help="Starting maze layout")
...
def main() -> None:
    args = parse_args()
    config = GameConfig(tile_size=args.tile_size, fps=args.fps, start_maze=args.maze, starting_lives=max(1, args.lives))
    GameApp(config).run()
